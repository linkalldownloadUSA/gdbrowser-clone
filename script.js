...
async function loadLevels() {
  ...
  try {
    ...
    list.innerHTML = "<li>Error loading levels.</li>";
  }
}
...
async function showProfile(playerId) {
  ...
  document.getElementById("profileIcon").src = `https://gdbrowser.com/icon/${prof.name}`;

  const createdList = document.getElementById("createdLevels");
...
async function loadComments(id, page) {
  try {
    ...
    document.getElementById("commentsList").innerHTML = "<li>Không thể tải bình luận.</li>";
  }
}
